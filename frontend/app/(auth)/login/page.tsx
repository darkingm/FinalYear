...
function LeftPanel() {
  ...
  return (
    <div className="hidden lg:flex w-[58%] relative overflow-hidden flex-col bg-[#06060e]">
      {/* Grid overlay */}
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#06060e]">
      ...
      {/* ── Right panel ── */}
      <div className="w-full lg:w-[42%] flex items-center justify-center relative overflow-hidden px-4 py-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-[#f0b90b] to-[#e6a800] text-black font-black rounded-xl text-sm hover:from-[#f7c82a] hover:to-[#f0b90b] transition-all hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#f0b90b]/20 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
            >
              {isLoading ? (
